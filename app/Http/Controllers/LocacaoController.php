...
class LocacaoController extends Controller
{
    ...
    public function criar(LocacaoRequest $request, $id, Copia $copia)
    {
        ...
        $locacao->data_devolucao = date('Y-m-d', strtotime($data_devolucao));
        $locacao->save();
        return Redirect::route('lista.copias', array('id' => $bibliotecas->id, 'livro' => $copia->livro_id))->with('success', 'Cópia Foi Emprestada com Sucesso');
    }
