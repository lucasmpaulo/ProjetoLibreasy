        ...
        <div class="col-md-10">
            <div class="tabela-custom fonte-form ">
                <div class="header-custom divisor-cabecalho m-t-md">
                    <h3 class="text-center p-t-md">{{ __('Cadastrar-se') }}</h3>
                </div>
                ...
                <div class="card-body ">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input style="text-transform:none;" id="email" type="email" class="fonte-form-email form-control fonte-form-email @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input style="text-transform:none;" id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input style="text-transform:none;" id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
